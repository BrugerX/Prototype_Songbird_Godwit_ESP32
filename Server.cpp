...
#define SNSR_CALIBRTN_SRVI_UUID "0004"
#define SNSR_CALIBRTNA_CHAR_UUID "0005"
#define SNSR_CALIBRTNB_CHAR_UUID "0006"
...
void setup() {
    ...
    NimBLEService * pCalibrtnService = pServer->createService(SNSR_CALIBRTN_SRVI_UUID);
    NimBLECharacteristic * pCalibrtnAChr = pCalibrtnService->createCharacteristic(
            SNSR_CALIBRTNA_CHAR_UUID,
    ...
    NimBLECharacteristic * pCalibrtnBChr = pCalibrtnService->createCharacteristic (
            SNSR_CALIBRTNB_CHAR_UUID,
            NIMBLE_PROPERTY::READ| NIMBLE_PROPERTY::WRITE | NIMBLE_PROPERTY::READ_ENC|NIMBLE_PROPERTY::WRITE_ENC
    );
    ...
    if(pServer->getConnectedCount()) {
        ...
        if(pBatriSvc) {
            ...
            if(pChr) {
                ...
                {
                    pChr->setValue(std::to_string(btriVoltage));
                }
        ...
        NimBLEServer * pSnsrSrvice;
    }

    //Serial.print(SWC_sensor->read());
    //Serial.print(SWC_sensor->read_voltage());
